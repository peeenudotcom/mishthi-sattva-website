  ...
  return (
    <header style={{ position: "sticky", top: 0, zIndex: 50, background: "var(--primary)", borderBottom: "1px solid color-mix(in oklab, var(--cream) 12%, transparent)", boxShadow: "0 8px 24px -12px color-mix(in oklab, var(--forest-deep) 60%, transparent)" }}>
      ...
      <div className="shop-head" style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px", minHeight: 88, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20 }}>
        <a href="../website/index.html" title="Back to Mishthi Sattva home" style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", gap: 3, cursor: "pointer", textDecoration: "none" }}>
          ...
          <span aria-label="Ayurvedic · Satvic · Homemade" style={{ position: "relative", display: "block", width: 150, height: 16, fontSize: 0, lineHeight: 0 }}>
      ...
      <div className="ms-container ms-stack" style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1.2fr", gap: 40, padding: "72px 24px 48px" }}>
        <div>
          ...
          <div style={{ maxWidth: 300 }}>
            <img src="../../assets/mishthi-logo-white.png" alt="Mishthi Sattva — Ayurvedic, Satvic, Homemade" style={{ height: 112, width: "auto", objectFit: "contain", display: "block", margin: "0 auto" }} />
...
function Shop() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--background)", color: "var(--foreground)" }}>
      {/* Floating WhatsApp help button — matches the rest of the site, present on the shop too. */}
      <a href={"https://wa.me/" + PHONE} target="_blank" rel="noopener noreferrer" aria-label="Chat with us on WhatsApp" title="Need Help? Chat With Us"
         style={{ position: "fixed", bottom: 20, right: 20, zIndex: 90, display: "grid", placeItems: "center", height: 56, width: 56, borderRadius: "var(--radius-pill)", background: "var(--primary)", color: "var(--cream)", boxShadow: "var(--shadow-xl)", border: "4px solid color-mix(in oklab, var(--gold) 45%, transparent)" }}>
